...
<br>
<input type="button" value=" Save Pilot Info " onclick="main.submit();" class="block-button">
<input type="button" value=" Delete Pilot " onclick="deletepilot.submit();" class="block-button">
