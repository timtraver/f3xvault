<div class="page type-page status-publish hentry clearfix post nodate">
	<div class="entry clearfix">                
		<h1 class="post-title entry-title">Browse Planes</h1>
...
<tr style="background-color: lightgray;">
        <td align="left" colspan="4">
                {if $startrecord>1}[<a href="?action=admin&function=admin_plane_list&page={$prevpage|escape}"> &lt;&lt; Prev Page</a>]{/if}
                {if $endrecord<$totalrecords}[<a href="?action=admin&function=admin_plane_list&page={$nextpage|escape}">Next Page &gt;&gt</a>]{/if}
        </td>
        <td align="right" colspan="4">PerPage
                [<a href="?action=admin&function=admin_plane_list&perpage=25">25</a>]
                [<a href="?action=admin&function=admin_plane_list&perpage=50">50</a>]
                [<a href="?action=admin&function=admin_plane_list&perpage=100">100</a>]
                [<a href="?action=admin&function=admin_plane_list&page=1">First Page</a>]
                [<a href="?action=admin&function=admin_plane_listpage={$totalpages|escape}">Last Page</a>]
        </td>
</tr>
<tr>
...
<tr bgcolor="{cycle values="#FFFFFF,#E8E8E8"}">
	...
	<td>
		<a href="?action=admin&function=admin_plane_view&plane_id={$p.plane_id|escape}">{$p.plane_name|escape}</a>
	</td>
	<td>
...
<tr style="background-color: lightgray;">
        ...
        <td align="right" colspan="4">PerPage
                ...
                [<a href="?action=admin&function=admin_plane_list&perpage=100">100</a>]
                [<a href="?action=admin&function=admin_plane_list&page=1">First Page</a>]
                [<a href="?action=admin&function=admin_plane_list&page={$totalpages|escape}">Last Page</a>]
        </td>
</tr>
<tr>
	<td colspan="8" align="center">
		<input type="button" value=" Combine Selected Planes " onclick="main.submit();" class="block-button">
	</td>
</tr>
</table>
</form>
