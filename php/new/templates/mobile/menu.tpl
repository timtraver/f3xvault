<div class="page-sidebar">
  <div class="page-sidebar-scroll">  
	<a href="#" class="sidebar-button hide2-sidebar"><em class="sidebar-button-close">COLLAPSE</em></a>
	{if $user.user_id!=0}
		<a href="?action=main&function=logout" class="sidebar-button"><em class="sidebar-button-close">Log Out</em></a>
	{else}
		<a href="?action=main&function=login" class="sidebar-button"><em class="sidebar-button-close">Log In</em></a>
		<a href="?action=register" class="sidebar-button"><em class="sidebar-button-close">Register</em></a>
	{/if}
	<div class="clear"></div>  
	<div class="menu">         
		<div class="menu-item">
