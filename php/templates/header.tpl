...
<body class="home custom-background">
	<div id="global-nav">
		...
		<div id="nav-all" class="embossed-nav">
			<a href="?action={$action}&function={$function}&disc=all"{if $disc=='all' || $disc==''} style="color:red;"{/if}>All</a>
		</div>
		<div id="nav-f3b" class="embossed-nav">
			<a href="?action={$action}&function={$function}&disc=f3b"{if $disc=='f3b'} style="color:red;"{/if}>F3B</a>
		</div>
		<div id="nav-f3f" class="embossed-nav">
			<a href="?action={$action}&function={$function}&disc=f3f"{if $disc=='f3f'} style="color:red;"{/if}>F3F</a>
		</div>
		<div id="nav-f3j" class="embossed-nav">
			<a href="?action={$action}&function={$function}&disc=f3j"{if $disc=='f3j'} style="color:red;"{/if}>F3J</a>
		</div>
		<div id="nav-f3k" class="embossed-nav">
			<a href="?action={$action}&function={$function}&disc=f3k"{if $disc=='f3k'} style="color:red;"{/if}>F3K</a>
		</div>
		<div id="nav-td" class="embossed-nav">
			<a href="?action={$action}&function={$function}&disc=td"{if $disc=='td'} style="color:red;"{/if}>TD</a>
		</div>
		{if $user.user_id!=0}
