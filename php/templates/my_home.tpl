	...
	<div class="panel-body">
		...
		<p>
			<center>
				...
				<a href="?action=pilot&function=pilot_view&pilot_id={$user.pilot_id}" class="btn btn-block btn-primary btn-rounded" style="font-size: 18px;"><i class="fa fa-user" style="float:left;padding-top: 3px;"></i>View My Pilot Profile</a><br>
				...
				{if $future|count !=0}
					<div class="btn-group" style="display:block;">
						...
						<ul class="dropdown-menu" style="width:100%;position: relative;">
							{foreach $future as $f}
								<li><a href="?action=event&function=event_view&event_id={$f.event_id}">{$f.event_start_date|date_format:"%y-%m-%d"} - {$f.event_name|truncate:"30"}</a></li>
							{/foreach}
						</ul>
					</div>
					<br>
				...
				{if $past|count !=0}
					<div class="btn-group" style="display:block;">
						...
						<ul class="dropdown-menu" style="width:100%;position: relative;">
							{foreach $past as $p}
								<li><a href="?action=event&function=event_view&event_id={$p.event_id}">{$p.event_start_date|date_format:"%y-%m-%d"} - {$p.event_name|truncate:"30"}</a></li>
							{/foreach}
						</ul>
					</div>
					<br>
				...
				<a href="?action=plane" class="btn btn-block btn-primary btn-rounded" style="font-size: 18px;"><i class="fa fa-plane" style="float:left;padding-top: 3px;"></i>Browse Planes</a><br>
				<a href="?action=location" class="btn btn-block btn-primary btn-rounded" style="font-size: 18px;"><i class="fa fa-globe" style="float:left;padding-top: 3px;"></i>Browse Locations</a><br>
				<a href="?action=main&function=view_home&slideshow=1&user_only=1" class="btn btn-block btn-mint btn-rounded" style="font-size: 18px;"><i class="fa fa-area-chart" style="float:left;padding-top: 3px;"></i>View My Slide Show</a><br>
