<div class="page type-page status-publish hentry clearfix post nodate">
	<div class="entry clearfix">                
		<h1 class="post-title entry-title">Pilot Comparison and Merge</h1>
...
<tr>
	<th>Make Primary</th>
	<td colspan="3" bgcolor="grey"><input type="radio" name="make_primary" value="{$pilot.pilot_id}" CHECKED> Pilot ID {$pilot.pilot_id}</td>
</tr>
<tr>
...
{/foreach}
		...
		<input type="button" value=" Merge To Selected Primary Pilot ID " onclick="main.submit();" class="block-button">
