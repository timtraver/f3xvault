...
<tr style="background-color: lightgray;">
        <td align="left" colspan="3">
                {if $startrecord>1}[<a href="?action=admin&function=admin_user_list&page={$prevpage|escape}"> &lt;&lt; Prev Page</a>]{/if}
                {if $endrecord<$totalrecords}[<a href="?action=admin&function=admin_user_list&page={$nextpage|escape}">Next Page &gt;&gt</a>]{/if}
        </td>
        <td align="right" colspan="4">PerPage
                [<a href="?action=admin&function=admin_user_list&&perpage=25">25</a>]
                [<a href="?action=admin&function=admin_user_list&&perpage=50">50</a>]
                [<a href="?action=admin&function=admin_user_list&&perpage=100">100</a>]
                [<a href="?action=admin&function=admin_user_list&page=1">First Page</a>]
                [<a href="?action=admin&function=admin_user_list&page={$totalpages|escape}">Last Page</a>]
        </td>
</tr>
<tr>
...
<tr bgcolor="{cycle values="#FFFFFF,#E8E8E8"}">
	...
	<td>
		<a href="?action=admin&function=admin_user_view&pilot_id={$p.pilot_id|escape}">{$p.pilot_first_name|escape} {$p.pilot_last_name|escape}</a>
	</td>
	<td>
		{$p.pilot_ama} - {$p.pilot_fai}
	</td>
	<td>
		<a href="?action=admin&function=pilot_view&pilot_id={$p.pilot_id|escape}">{$p.user_name|escape}</a>
	</td>
	<td>
...
<tr>
	<td colspan="7" align="center">
		<input type="button" value=" Combine Selected Pilots " onclick="main.submit();" class="block-button">
