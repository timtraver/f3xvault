...
<tr>
	<th width="5%" align="right" nowrap>Flight Type</th>
	<td>
...
<tr>
	<th width="5%" align="right" nowrap>Rounds</th>
	<td>
		{$d->draw.event_draw_round_from} to {$d->draw.event_draw_round_to}
	</td>
</tr>
<tr>
	<th nowrap align="right">Team Prot</th>
	<td>
		{if $d->draw.event_draw_team_protection==1} ON{else}OFF{/if}
	</td>
</tr>
<tr>
	<th nowrap align="right" valign="top">Groups</th>
	<td>
...
<tr>
	<th align="right">Average # of<br>Pilot-Pilot Meetings</th>
...
<tr>
	<th nowrap align="right" valign="top">Matchup Details</th>
	<td>
