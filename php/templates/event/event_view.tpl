		...
		<div class="tab-base" style="margin-top: 10px;">
			...
			<div class="tab-content">
				...
				<div id="pilot-tab-3" class="tab-pane fade{if $tab==3} active in{/if}">
					...
					<div>
						<div>                
							<button class="btn btn-primary btn-rounded" id="change_pilot_info_button" type="button" onclick="window.open('?action=event&function=event_draw_view&event_draw_id={$draw_info.event_draw_id}&event_id={$event->info.event_id}&flight_type_id={$draw_info.flight_type_id}&use_print_header=1','_blank');"> Print Draw </button>
