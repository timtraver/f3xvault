	...
	<div class="panel-body">
		...
		<tr>
			...
			<td colspan="3">
				{if $event->info.event_reg_status == 0 || 
					...
					<font color="green">(Registration opens on {date_in_timezone("Y-m-d h:i a",$event->info.event_reg_open_date_stamp,$event->info.event_reg_open_tz)} - {$event->info.event_reg_open_tz|escape} Time Zone)</font>
					{/if}
					<br>
				{else}
		...
		<div class="btn-group" style="float: right;width: 200px;">
			...
			<ul class="dropdown-menu dropdown-menu-right" style="width: 200px;">
				...
				<li><a href="#" onClick="if(check_permission()){ldelim}document.event_tasks.submit();{rdelim}">Set F3L Tasks</a></li>
				{/if}
