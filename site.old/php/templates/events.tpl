<div id="post-1" class="post-1 post type-post status-publish format-standard hentry category-uncategorized clearfix post">
	<div class="entry clearfix">
		<h2 class="post-title entry-title">F3X Competition Events and Series</h2>

				<div class="entry-content clearfix">
					<p>
						This is the Competition area of the site!<br>
						<br>
						<center>
						<img src="images/vampire_launch.jpg" width="400"><br>
						...
						<br>
						<center>
						<input type="button" value=" Browse Contest Events " class="button" style="display:inline;float:none;" onClick="document.browse_events.submit();">
						<input type="button" value=" Browse Contest Series " class="button" style="display:inline;float:none;" onClick="document.browse_series.submit();">
						</center>
						<br>
						<br>
					</p>
